...
import { AMBIENT_SOUNDS, getAmbientsByCategory, type AmbientSoundId } from '@/lib/audio/ambient';
...
const CATEGORY_ORDER = ['control', 'weather', 'nature', 'cozy', 'urban', 'atmospheric', 'musical', 'focus'];
