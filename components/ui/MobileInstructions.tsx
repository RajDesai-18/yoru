        ...
        >
          ...
          >
            ...
            <div className="space-y-4">
              <Instruction
                symbol="←  →"
                label="Tap left / right"
                detail="Change scenes"
              />
              <Instruction
                symbol="●"
                label="Tap Once"
                detail="Show / hide controls"
              />
              <Instruction
                symbol="●●"
                label="Double-tap center"
                detail="Play / pause"
              />
              <Instruction
                symbol="↕"
                label="Swipe up / down"
                detail="Adjust volume"
              />
              <Instruction
                symbol="♪"
                label="Tap volume icon"
                detail="Show volume slider"
              />
              <Instruction
                symbol="●●"
                label="Tap volume icon"
              ...
              />
              <Instruction
                symbol={<Radio className="h-4 w-4" />}
                label="Tap ambient icon"
                detail="Change sounds"
              />
            </div>
